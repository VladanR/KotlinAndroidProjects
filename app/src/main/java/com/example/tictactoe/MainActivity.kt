...
@Composable
fun TTTScreen() {
    // true = players turn  false = AI turn
    val playerTurn = remember { mutableStateOf(true) }
    val moves = remember {
        mutableStateListOf<Boolean?>(
            true, null, false, true, false, null, null, null, null
        )
    }
...
fun Header(playerTurn: Boolean) {
    Row(
        ...
        val aitBoxColor = if (!playerTurn) Color.Red else Color.LightGray
